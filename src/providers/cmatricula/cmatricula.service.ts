...
export class  CmatriculaService{
  httpHeaders = {
  ...
  public updateCmatricula(id: number, params): Observable<any> {
    return this.httpClient.put(`${environment.url}${this.endPoint}${id}`, params, this.httpHeaders)
      .pipe(retry(1),
        catchError(this.httpError));
  }

  public deleteCmatricula(id: number): Observable<any> {
